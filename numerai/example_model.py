...
def main():
    ...
    training_data = read_csv("../data/20200912/numerai_training_data.csv")
    # The tournament data is the data that Numerai uses to evaluate your model.
    tournament_data = read_csv("../data/20200912/numerai_tournament_data.csv")
    ...
    example_preds = pd.read_csv("../data/20200912/example_predictions_target_kazutsugi.csv").set_index("id")["prediction_kazutsugi"]
